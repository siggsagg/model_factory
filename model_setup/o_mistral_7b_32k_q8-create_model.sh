...
custom_model_name="mf-o-mis-7b-32k-q8"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_mistral_7b_32k_q8-ModelFile
...
#    chmod +x o_mistral_7b_32k_q8-create_model.sh
# 5. Run the executable .sh file with the command: ./o_mistral_7b_32k_q8-create_model.sh
