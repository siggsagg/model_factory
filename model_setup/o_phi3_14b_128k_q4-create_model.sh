...
# variables
model_name="phi3:14b-medium-128k-instruct-q4_K_M"

custom_model_name="mf-o-phi3-14b-128k-q4"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_phi3_14b_128k_q4-ModelFile
...
#    chmod +x o_phi3_14b_128k_q4-create_model.sh
# 5. Run the executable .sh file with the command: ./o_phi3_14b_128k_q4-create_model.sh
