...
# variables
model_name="phi3:3.8b-mini-4k-instruct-f16"

custom_model_name="mf-o-phi3-3b-4k-fp16"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_phi3_3b_4k_fp16-ModelFile
...
#    chmod +x o_phi3_3b_4k_fp16-create_model.sh
# 5. Run the executable .sh file with the command: ./o_phi3_3b_4k_fp16-create_model.sh
