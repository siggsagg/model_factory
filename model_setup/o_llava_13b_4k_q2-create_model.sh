...
# variables
model_name="llava:13b-v1.6-vicuna-q2_K"

custom_model_name="mf-o-lva-13b-4k-q2"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llava_13b_4k_q2-ModelFile
...
#    chmod +x o_llava_13b_4k_q2-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llava_13b_4k_q2-create_model.sh
