...
custom_model_name="mf-o-lma3-70b-8k-fp16"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llama3_70b_8k_fp16-ModelFile
...
#    chmod +x o_llama3_70b_8k_fp16-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llama3_70b_8k_fp16-create_model.sh
