...
custom_model_name="mf-o-lva-34b-4k-fp16"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llava_34b_4k_fp16-ModelFile
...
#    chmod +x o_llava_34b_4k_fp16-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llava_34b_4k_fp16-create_model.sh
