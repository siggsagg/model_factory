...
# variables
model_name="llava:13b-v1.6-vicuna-fp16"

custom_model_name="mf-o-lva-13b-4k-fp16"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llava_13b_4k_fp16-ModelFile
...
#    chmod +x o_llava_13b_4k_fp16-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llava_13b_4k_fp16-create_model.sh
