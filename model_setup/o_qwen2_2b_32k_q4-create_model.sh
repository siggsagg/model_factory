...
# variables
model_name="qwen2:1.5b-instruct-q4_0"

custom_model_name="mf-o-qwn2-2b-32k-q4"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_qwen2_2b_32k_q4-ModelFile
...
#    chmod +x o_qwen2_2b_32k_q4-create_model.sh
# 5. Run the executable .sh file with the command: ./o_qwen2_2b_32k_q4-create_model.sh
