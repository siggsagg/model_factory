...
# variables
model_name="phi3:3.8b-mini-4k-instruct-q2_K"

custom_model_name="mf-o-phi3-3b-4k-q2"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_phi3_3b_4k_q2-ModelFile
...
#    chmod +x o_phi3_3b_4k_q2-create_model.sh
# 5. Run the executable .sh file with the command: ./o_phi3_3b_4k_q2-create_model.sh
