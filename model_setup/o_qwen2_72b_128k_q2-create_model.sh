...
# variables
model_name="qwen2:72b-instruct-q2_K"

custom_model_name="mf-o-qwn2-72b-128k-q2"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_qwen2_72b_128k_q2-ModelFile
...
#    chmod +x o_qwen2_72b_128k_q2-create_model.sh
# 5. Run the executable .sh file with the command: ./o_qwen2_72b_128k_q2-create_model.sh
