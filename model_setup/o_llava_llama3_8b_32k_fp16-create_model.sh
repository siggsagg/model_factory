...
# variables
model_name="llava-llama3:8b-v1.1-fp16"

custom_model_name="mf-o-lva-8b-32k-fp16"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llava_llama3_8b_32k_fp16-ModelFile
...
#    chmod +x o_llava_llama3_8b_32k_fp16-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llava_llama3_8b_32k_fp16-create_model.sh
