...
# variables
model_name="llava-phi3:3.8b-mini-q4_0"

custom_model_name="mf-o-lvaphi3-3b-4k-q4"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llava_phi3_3b_4k_q4-ModelFile
...
#    chmod +x o_llava_phi3_3b_4k_q4-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llava_phi3_3b_4k_q4-create_model.sh
