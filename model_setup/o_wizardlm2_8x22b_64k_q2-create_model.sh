...
# variables
model_name="wizardlm2:8x22b-q2_K"

custom_model_name="mf-o-wizlm2-8x22b-64k-q2"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_wizardlm2_8x22b_64k_q2-ModelFile
...
#    chmod +x o_wizardlm2_8x22b_64k_q2-create_model.sh
# 5. Run the executable .sh file with the command: ./o_wizardlm2_8x22b_64k_q2-create_model.sh
