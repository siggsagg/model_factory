...
# variables
model_name="mixtral:8x22b-instruct-v0.1-q6_K"

custom_model_name="mf-o-mix-8x22b-64k-q6"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_mixtral_8x22b_64k_q6-ModelFile
...
#    chmod +x o_mixtral_8x22b_64k_q6-create_model.sh
# 5. Run the executable .sh file with the command: ./o_mixtral_8x22b_64k_q6-create_model.sh
