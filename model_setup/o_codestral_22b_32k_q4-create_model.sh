...
# variables
model_name="codestral:22b-v0.1-q4_0"

custom_model_name="mf-o-cstral-22b-32k-q4"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_codestral_22b_32k_q4-ModelFile
...
#    chmod +x o_codestral_22b_32k_q4-create_model.sh
# 5. Run the executable .sh file with the command: ./o_codestral_22b_32k_q4-create_model.sh
