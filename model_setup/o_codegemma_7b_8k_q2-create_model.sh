...
# variables
model_name="codegemma:7b-code-q2_K"

custom_model_name="mf-o-cgma-7b-8k-q2"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_codegemma_7b_8k_q2-ModelFile
...
#    chmod +x o_codegemma_7b_8k_q2-create_model.sh
# 5. Run the executable .sh file with the command: ./o_codegemma_7b_8k_q2-create_model.sh
