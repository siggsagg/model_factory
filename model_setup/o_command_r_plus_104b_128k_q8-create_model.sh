...
# variables
model_name="command-r-plus:104b-q8_0"

custom_model_name="mf-o-cmd-rp-104b-128k-q8"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_command_r_plus_104b_128k_q8-ModelFile
...
#    chmod +x o_command_r_plus_104b_128k_q8-create_model.sh
# 5. Run the executable .sh file with the command: ./o_command_r_plus_104b_128k_q8-create_model.sh
