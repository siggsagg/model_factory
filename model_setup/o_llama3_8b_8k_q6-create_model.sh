...
custom_model_name="mf-o-lma3-8b-8k-q6"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llama3_8b_8k_q6-ModelFile
...
#    chmod +x o_llama3_8b_8k_q6-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llama3_8b_8k_q6-create_model.sh
