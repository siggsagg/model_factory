...
# variables
model_name="command-r:35b-v0.1-q2_K"

custom_model_name="mf-o-cmd-r-35b-128k-q2"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_command_r_35b_128k_q2-ModelFile
...
#    chmod +x o_command_r_35b_128k_q2-create_model.sh
# 5. Run the executable .sh file with the command: ./o_command_r_35b_128k_q2-create_model.sh
