...
# variables
model_name="wizardlm2:8x22b-q8_0"

custom_model_name="mf-o-wizlm2-8x22b-64k-q8"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_wizardlm2_8x22b_64k_q8-ModelFile
...
#    chmod +x o_wizardlm2_8x22b_64k_q8-create_model.sh
# 5. Run the executable .sh file with the command: ./o_wizardlm2_8x22b_64k_q8-create_model.sh
