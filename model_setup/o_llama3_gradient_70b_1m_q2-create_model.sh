...
# variables
model_name="llama3-gradient:70b-instruct-1048k-q2_K"

custom_model_name="mf-o-l3g-70b-1m-q2"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llama3_gradient_70b_1m_q2-ModelFile
...
#    chmod +x o_llama3_gradient_70b_1m_q2-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llama3_gradient_70b_1m_q2-create_model.sh
