...
# variables
model_name="llava:7b-v1.6-vicuna-q6_K"

custom_model_name="mf-o-lva-7b-4k-q6"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_llava_7b_4k_q6-ModelFile
...
#    chmod +x o_llava_7b_4k_q6-create_model.sh
# 5. Run the executable .sh file with the command: ./o_llava_7b_4k_q6-create_model.sh
