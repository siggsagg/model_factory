...
custom_model_name="mf-o-mix-8x7b-32k-q6"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_mixtral_8x7b_32k_q6-ModelFile
...
#    chmod +x o_mixtral_8x7b_32k_q6-create_model.sh
# 5. Run the executable .sh file with the command: ./o_mixtral_8x7b_32k_q6-create_model.sh
