...
# variables
model_name="dbrx:132b-instruct-fp16"

custom_model_name="mf-o-dbrx-132b-32k-fp16"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_dbrx_132b_32k_fp16-ModelFile
...
#    chmod +x o_dbrx_132b_32k_fp16-create_model.sh
# 5. Run the executable .sh file with the command: ./o_dbrx_132b_32k_fp16-create_model.sh
