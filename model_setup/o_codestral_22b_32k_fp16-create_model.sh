...
# variables
model_name="codestral:22b-v0.1-f16"

custom_model_name="mf-o-cstral-22b-32k-fp16"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_codestral_22b_32k_fp16-ModelFile
...
#    chmod +x o_codestral_22b_32k_fp16-create_model.sh
# 5. Run the executable .sh file with the command: ./o_codestral_22b_32k_fp16-create_model.sh
