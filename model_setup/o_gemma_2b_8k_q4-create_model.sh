...
# variables
model_name="gemma:2b-instruct-v1.1-q4_0"

custom_model_name="mf-o-gma-2b-8k-q4"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_gemma_2b_8k_q4-ModelFile
...
#    chmod +x o_gemma_2b_8k_q4-create_model.sh
# 5. Run the executable .sh file with the command: ./o_gemma_2b_8k_q4-create_model.sh
