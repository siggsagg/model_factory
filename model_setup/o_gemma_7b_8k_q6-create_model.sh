...
# variables
model_name="gemma:7b-instruct-v1.1-q6_K"

custom_model_name="mf-o-gma-7b-8k-q6"

#get the base model
ollama pull $model_name

#create the model file
ollama create $custom_model_name -f ./o_gemma_7b_8k_q6-ModelFile
...
#    chmod +x o_gemma_7b_8k_q6-create_model.sh
# 5. Run the executable .sh file with the command: ./o_gemma_7b_8k_q6-create_model.sh
